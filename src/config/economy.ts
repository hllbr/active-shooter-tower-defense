...
export const economyConfig = {
  ...
  // Extractor income system - dramatically improved
  extractorIncome: {
    // Base income per level (exponential growth)
    baseByLevel: [
      50,   // Level 1: 50 gold/wave
      ...
      3000, // Level 11+: 3000+ (for late game)
    ],
    
    // Compound interest multiplier
    compoundMultiplier: 1.08, // 8% compound growth per wave
    
    // Wave scaling factor (gets better over time)
    waveScalingFactor: 0.05, // 5% per wave
    
    // Maximum wave scaling cap
    maxWaveScaling: 3.0, // 300% max scaling
    
    // Late game bonus threshold
